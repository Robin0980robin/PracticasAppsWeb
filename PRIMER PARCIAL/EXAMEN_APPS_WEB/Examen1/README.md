...
1. **User:** 
    - Representa al usuario que crea y estudia las flashcards. 
    - Permite personalizar la experiencia de estudio, asociar flashcards y registrar interacciones de estudio por usuario.
    - Atributos: id, nombre, email, password

2. **Flashcard:**
    - Es la tarjeta educativa que contiene una pregunta y su respuesta.
    - Constituye el recurso principal de aprendizaje. Se puede organizar por categorías y vincular al creador.
    - Atributos: id, pregunta, respuesta, categorías, creadorId

3. **Category:**
    - Agrupa flashcards bajo una temática común.
    - Facilita la organización del contenido y la selección del material de estudio según intereses o materias.
    - Atributos: id, nombre

4. **StudySession:**
    - Registra cada vez que un usuario estudia una flashcard.
    - Permite implementar técnicas de memoria espaciada, medir progreso y adaptar el estudio según el desempeño del usuario.
    - Atributos: id, usuarioId, flashcardId, fechaEstudio, acertada
