...
import { EstudianteSequelizeRepository } from "../../infrastructure/repositories/estudiante.sequelize.repository";
...
const repo = new EstudianteSequelizeRepository();
...
export class EstudianteSequelizeController {
